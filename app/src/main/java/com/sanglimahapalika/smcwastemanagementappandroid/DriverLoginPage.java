...
public class DriverLoginPage extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent90 =new Intent(DriverLoginPage.this,AllLoginButtons.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(DriverLoginPage.this,DriverFPPhoneNumber.class);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mymobile.isEmpty()){
                    ...
                    Intent intent=new Intent(DriverLoginPage.this,DriverLoginLoading.class);
                    ...
                    Toast.makeText(DriverLoginPage.this, "Inalid Email or Password", Toast.LENGTH_SHORT).show();
                }
