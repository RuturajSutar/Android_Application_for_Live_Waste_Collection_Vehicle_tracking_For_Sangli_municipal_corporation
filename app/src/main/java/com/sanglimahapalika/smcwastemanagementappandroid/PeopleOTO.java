...
public class PeopleOTO extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PeopleOTO.this);
        ...
        builder.setMessage("Are you sure to cancel this operation..?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(PeopleOTO.this,PeopleLoginPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_people_oto);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    startActivity(intent);
                    Toast.makeText(PeopleOTO.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(PeopleOTO.this, "Please Enter Correct OTP, Verification Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
