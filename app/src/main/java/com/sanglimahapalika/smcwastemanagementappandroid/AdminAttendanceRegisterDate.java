...
public class AdminAttendanceRegisterDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_register_date);
        ...
        ref=database.getReference().child("Attendance").child(myyear).child(mymonth);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminAttendanceRegisterDate.this,AdminAttendanceRegisterPresentAbsent.class);
