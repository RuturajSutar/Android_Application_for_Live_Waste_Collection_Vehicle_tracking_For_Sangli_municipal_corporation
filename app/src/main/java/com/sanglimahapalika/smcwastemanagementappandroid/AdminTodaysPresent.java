...
public class AdminTodaysPresent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_todays_present);
        ...
        ref=database.getReference().child("Attendance").child(myyear).child(mymonth).child(myday).child("Present");
