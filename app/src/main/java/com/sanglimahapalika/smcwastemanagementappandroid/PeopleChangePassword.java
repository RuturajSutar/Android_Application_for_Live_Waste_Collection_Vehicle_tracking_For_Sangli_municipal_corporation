...
public class PeopleChangePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_people_change_password);
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (oldpass.isEmpty()){
                    ...
                    mRef1.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (oldpass.equals(opass)){
                                ...
                                Intent intent=new Intent(PeopleChangePassword.this,PeopleDashboard.class);
                                Toast.makeText(PeopleChangePassword.this, "Password Changed Successfuly", Toast.LENGTH_SHORT).show();
                                lottieAnimationView.setVisibility(View.INVISIBLE);
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            ...
                            Toast.makeText(PeopleChangePassword.this, "Error in Changing Password", Toast.LENGTH_SHORT).show();
                            lottieAnimationView.setVisibility(View.INVISIBLE);
                        }
                    });
                    ...
                    Toast.makeText(PeopleChangePassword.this, "Cannot change Password", Toast.LENGTH_SHORT).show();
                    lottieAnimationView.setVisibility(View.INVISIBLE);
                }
