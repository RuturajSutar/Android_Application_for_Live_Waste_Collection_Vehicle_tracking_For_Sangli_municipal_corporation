...
public class AdminAttendanceRegisterPresent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_register_present);
        ...
        ref=database.getReference().child("Attendance").child(myyear).child(mymonth).child(mydate).child("Present");
