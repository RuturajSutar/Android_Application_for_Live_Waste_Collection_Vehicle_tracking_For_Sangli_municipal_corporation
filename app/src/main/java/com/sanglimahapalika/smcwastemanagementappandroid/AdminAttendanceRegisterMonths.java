...
public class AdminAttendanceRegisterMonths extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_attendance_register_months);
        ...
        ref=database.getReference().child("Attendance").child(myyear);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AdminAttendanceRegisterMonths.this,AdminAttendanceRegisterDate.class);
