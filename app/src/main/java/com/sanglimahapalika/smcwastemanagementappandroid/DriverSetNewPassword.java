...
public class DriverSetNewPassword extends AppCompatActivity {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DriverSetNewPassword.this);
        ...
        builder.setMessage("Are you sure to cancel this operation..?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent80 = new Intent(DriverSetNewPassword.this,DriverLoginPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_set_new_password);
        ...
        changePassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newpass.isEmpty()){
                    ...
                    Intent intent=new Intent(DriverSetNewPassword.this,DriverLoginPage.class);
                    Toast.makeText(DriverSetNewPassword.this, "Password Changed Successfuly", Toast.LENGTH_SHORT).show();
                    lottieAnimationView.setVisibility(View.INVISIBLE);
                    startActivity(intent);
                    finish();
                }
                else {
                    Toast.makeText(DriverSetNewPassword.this, "Cannot change Password", Toast.LENGTH_SHORT).show();
                    lottieAnimationView.setVisibility(View.INVISIBLE);
                }
