...
public class DriverAllComplaintDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_all_complaint_dashboard);
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        try {
                            ...
                            Intent intent1 = new Intent(DriverAllComplaintDashboard.this,ComplaintLocation.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DriverAllComplaintDashboard.this, "Unknown Error", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DriverAllComplaintDashboard.this, "Error in Loading Files", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(DriverAllComplaintDashboard.this, "Error in Loading Resourse", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
