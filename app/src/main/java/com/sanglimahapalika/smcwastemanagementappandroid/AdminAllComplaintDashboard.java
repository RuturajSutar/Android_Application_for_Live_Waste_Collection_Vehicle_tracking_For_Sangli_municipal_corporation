...
public class AdminAllComplaintDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_all_complaint_dashboard);
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        try {
                            ...
                            Intent intent1 = new Intent(AdminAllComplaintDashboard.this,ComplaintLocation.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(AdminAllComplaintDashboard.this, "Unknown Error", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminAllComplaintDashboard.this, "Error in Loading Files", Toast.LENGTH_SHORT).show();
                    }
                });
            }
