...
public class DriverTodaysComplaintDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_todays_complaint_dashboard);
                ...
                myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        try {
                            ...
                            Intent intent1 = new Intent(DriverTodaysComplaintDashboard.this,ComplaintLocation.class);
                            ...
                            e.printStackTrace();
                            Toast.makeText(DriverTodaysComplaintDashboard.this, "Unknown Error", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(DriverTodaysComplaintDashboard.this, "Error in Loading Files", Toast.LENGTH_SHORT).show();
                    }
                });
            }
